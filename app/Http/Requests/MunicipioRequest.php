...
class MunicipioRequest extends FormRequest
{
    ...
    {
        return [
            'nombre_municipio.required' => 'El campo nombre del municipio es obligatorio.',
            'nombre_municipio.string' => 'El campo nombre del municipio debe ser una cadena de texto.',
            'nombre_municipio.max' => 'El campo nombre del municipio no puede tener más de 255 caracteres.',
